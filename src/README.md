...
* **Entity Existence:** The system verifies that patientId and providerId (key identifier for model.Patient and model.Provider objects) actually exist before allowing scheduling.
...
* **NO model.Provider Overlaps:** The system loops through a provider's existing schedule to ensure new or rescheduled appointments do not overlap with existing commitments.
